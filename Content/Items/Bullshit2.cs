...
namespace HendecamMod.Content.Items
{
    ...
    public class Bullshit2 : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GalaxyProj>(); // ID of the projectiles the sword will shoot
            Item.shootSpeed = 12.75f; // Speed of the projectiles the sword will shoot
