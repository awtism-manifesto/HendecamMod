...
public class UraniumTorch : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.DefaultToTorch(TileType<Tiles.UraniumTorchPlaced>(), 0);
        Item.value = 127;
    }
    ...
    public override void HoldItem(Player player)
    {
        ...
        {
            Dust dust = Dust.NewDustDirect(new Vector2(player.itemLocation.X + (player.direction == -1 ? -16f : 6f), player.itemLocation.Y - 14f * player.gravDir), 4, 4, DustID.CursedTorch, 0f, 0f, 100);
        ...
        Lighting.AddLight(position, 0.25f, 1f, 0.25f);
    }
    ...
    public override void PostUpdate()
    {
        ...
        if (!Item.wet)
        {
            Lighting.AddLight(Item.Center, 0.25f, 1f, 0.25f);
        }
    }
