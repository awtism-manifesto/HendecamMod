...
public class VerminImpaler : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.value = 115000; // The number and type of coins item can be sold for to an NPC
        ...
        Item.shoot = ProjectileType<VenomSpear>(); // The projectile that is fired from this weapon
    }

    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        type = ProjectileType<VenomFang>();
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Shoots venomous spider fangs");
        tooltips.Add(line);
