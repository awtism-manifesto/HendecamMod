...
public class Repentance : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.value = 90000; // The number and type of coins item can be sold for to an NPC
        ...
        Item.shoot = ProjectileType<MoltenSpear>(); // The projectile that is fired from this weapon
    }

    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        // Here we add a tooltipline that will later be removed, showcasing how to remove tooltips from an item
        var line = new TooltipLine(Mod, "Face", "Drops burning napalm upon hitting an enemy");
        tooltips.Add(line);
