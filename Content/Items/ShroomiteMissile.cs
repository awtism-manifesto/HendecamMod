...
public class ShroomiteMissile : ModItem
{
    ...
    {
        Item.damage = 63; // The damage for projectiles isn't actually 12, it actually is the damage combined with the projectile and the item together.
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Medium sized explosion, does not destroy tiles");
        tooltips.Add(line);
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient(ItemID.ClusterRocketI, 111);
        recipe.Register();
    }
}
