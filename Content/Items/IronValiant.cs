...
public class IronValiant : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.damage = 69; // The amount of damage the item does to an enemy or player.
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Sometimes releases hallowed lances while in flight");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "Releases more lances at higher velocities")
        {
