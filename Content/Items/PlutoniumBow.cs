...
public class PlutoniumBow : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts all arrows into Plutonium Arrows that recursively split and start homing when small enough");
        tooltips.Add(line);
