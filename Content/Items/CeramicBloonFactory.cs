...
public class CeramicBloonFactory : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.buffType = BuffType<CeramicBloonBuff>();
        // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
        Item.shoot = ProjectileType<CeramicBloon>(); // This item creates the minion projectile
        Item.shootSpeed = 8f;
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<CeramicSheet>(50);
        recipe.AddIngredient<Rubber>(75);
