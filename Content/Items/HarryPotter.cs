...
namespace HendecamMod.Content.Items
{
    public class HarryPotter: ModItem
    {
        ...
        {
            type = ModContent.ProjectileType<CeramMag>();
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "Creates a burst of sharp ceramic scraps at the mouse position that fly in random directions");
            tooltips.Add(line);
