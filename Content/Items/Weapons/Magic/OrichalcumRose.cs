...
public class OrichalcumRose : ModItem
{
    ...
    public override void HoldItem(Player player)
    {
        ...
        {
            Lighting.AddLight(player.Right, 1.61f, 0.45f, 1.56f);
        }
        else
        {
            Lighting.AddLight(player.Left, 1.61f, 0.45f, 1.56f);
        }
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Casts multiple venomous Orichalcum petals");
        tooltips.Add(line);
