...
public class MartianDrugs : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ProjectileType<MartianSyringePurple>();
    ...
    {
        type = ProjectileType<MartianSyringePurple>();
    }
