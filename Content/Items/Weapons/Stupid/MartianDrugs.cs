...
public class MartianDrugs : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.damage = 129; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
        ...
        Item.shoot = ModContent.ProjectileType<MartianSyringePurple>();
    ...
    {
        type = ModContent.ProjectileType<MartianSyringePurple>();
    }
