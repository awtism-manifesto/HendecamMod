...
public class ImprovisedMortarLauncher : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ProjectileType<ImprovMortar>();
    ...
    {
        type = ProjectileType<ImprovMortar>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<ImprovisedGrenadeLauncher>();
        recipe.AddIngredient<PocketMortar>();
