...
public class TheBlueBall : ModItem
{
    public override void SetStaticDefaults()
    {
        ...
        ItemID.Sets.GamepadExtraRange[Item.type] = 12; // Increases the gamepad range. Some vanilla values: 4 (Wood), 10 (Valor), 13 (Yelets), 18 (The Eye of Cthulhu), 21 (Terrarian).
    ...
    public override void SetDefaults()
    {
        ...
        Item.damage = 28; // The amount of damage the item does to an enemy or player.
        ...
        Item.shoot = ModContent.ProjectileType<BlueBallProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<MetalBall>();
