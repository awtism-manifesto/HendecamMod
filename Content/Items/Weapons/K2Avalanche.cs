...
public class K2Avalanche : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ProjectileType<AvalancheBoulder>();
    ...
    {
        type = ProjectileType<AvalancheBoulder>();
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Drops an avalanche of icy boulders on your enemies from the sky");
        tooltips.Add(line);
