...
public class MagicCue : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.value = 150000; // The number and type of coins item can be sold for to an NPC
        ...
        Item.shoot = ProjectileType<MagicSpear>(); // The projectile that is fired from this weapon
    }

    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        type = ProjectileType<MagicBall>();
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Shoots a homing magic 8 ball");
        tooltips.Add(line);
