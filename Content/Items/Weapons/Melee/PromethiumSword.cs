...
public class PromethiumSword : ModItem
{
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        Projectile.NewProjectileDirect(source, position, newVelocity, ProjectileType<PromethiumStar>(), (int)(damage * 0.67f), knockback, player.whoAmI);
        Projectile.NewProjectileDirect(source, position, new2Velocity, ProjectileType<PromethiumStar>(), (int)(damage * 0.67f), knockback, player.whoAmI);
        Projectile.NewProjectileDirect(source, position, new3Velocity, ProjectileType<PromethiumStar>(), (int)(damage * 0.67f), knockback, player.whoAmI);
