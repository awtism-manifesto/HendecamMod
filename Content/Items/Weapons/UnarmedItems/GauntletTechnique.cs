...
namespace HendecamMod.Content.Items.Weapons.UnarmedItems;

public class GauntletTechnique : ModItem
    {
    public override void SetDefaults()
        ...
        Item.value = 67;
        Item.shoot = ModContent.ProjectileType<GauntletProj>(); // The projectile is what makes a shortsword work
