...
public class AncientCobaltNaginata : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.value = 33000; // The number and type of coins item can be sold for to an NPC

        // Use Properties
        Item.useStyle = ItemUseStyleID.Shoot; // How you use the item (swinging, holding out, etc.)
        Item.useAnimation = 29; // The length of the item's use animation in ticks (60 ticks == 1 second.)
        Item.useTime = 29; // The length of the item's use time in ticks (60 ticks == 1 second.)
