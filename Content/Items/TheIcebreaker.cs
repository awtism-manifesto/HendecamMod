...
public class TheIcebreaker : ModItem
{
    ...
    {
        damage = (int)(damage * 0.63f);
        knockback = (int)(knockback * 0.15f);
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Calls down icicles from the sky while swinging");
        tooltips.Add(line);
