...
public class BillionaireBiter : ModItem
{
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        Vector2 new2Velocity = velocity.RotatedBy(MathHelper.ToRadians(-1.33f));
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts darts into rows of orca teeth that rip through enemy armor");
        tooltips.Add(line);
