...
public class PlasmaRifle2 : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Shoots explosive, critically unstable plasma blobs that create dangerous plasma pools upon exploding");
        tooltips.Add(line);
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<Items.PlasmaRifle>();
