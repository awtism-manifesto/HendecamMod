...
namespace HendecamMod.Content.Items.Placeables.Uno
    ...
    public class RedWild : ModItem
        ...
        public override void SetDefaults()
            {
            Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Uno.RedWild>());
            Item.width = 20;
            Item.height = 20;
            Item.value = 1;
            }
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
            {
            itemLoot.Add(ItemDropRule.NotScalingWithLuck(ModContent.ItemType<YellowWild>(), 1));
            }
        }
    }