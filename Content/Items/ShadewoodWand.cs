...
public class ShadewoodWand : ModItem
{
    ...
    {
        type = ModContent.ProjectileType<CrimSpark>();
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        line = new TooltipLine(Mod, "Face", "Shoots a spark of crimson energy")
        {
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient(ItemID.CrimsonTorch, 10);
        ...
        recipe.AddIngredient(ItemID.CrimsonTorch, 19);
