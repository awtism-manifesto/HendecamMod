...
public class CorruptLawman : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Wildly shoots six rounds in quick succession before a significant delay");
        tooltips.Add(line);
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<Items.PoliceBaton>();
