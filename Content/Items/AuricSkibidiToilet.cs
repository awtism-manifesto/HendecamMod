...
public class AuricSkibidiToilet : ModItem
{
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        Vector2 new3Velocity = velocity.RotatedBy(MathHelper.ToRadians(0));
        Vector2 new4Velocity = velocity.RotatedBy(MathHelper.ToRadians(-7.5f));
        Vector2 new5Velocity = velocity.RotatedBy(MathHelper.ToRadians(-15f));
