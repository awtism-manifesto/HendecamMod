...
public class BladeMaelstrom : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<BladeMaelstromProj>();
    }

    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        // Here we add a tooltipline that will later be removed, showcasing how to remove tooltips from an item
        var line = new TooltipLine(Mod, "Face", "Summons a blade maelstrom sentry that flings blades everywhere in a spiral pattern");
        tooltips.Add(line);
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<BladeShooter>();
        recipe.AddIngredient<CyberneticGunParts>(2);
        recipe.AddIngredient(ItemID.Spike, 48);
