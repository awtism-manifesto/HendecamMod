...
public class TheTackZone : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Summons The Tack Zone, which spews a ludicrous amount of tacks");
        tooltips.Add(line);
    ...
    public override void AddRecipes()
    {
        ...
        if (ModLoader.TryGetMod("Split", out Mod Sp) && Sp.TryFind("ElementOfPain", out ModItem ElementOfPain))
        {
            recipe.AddIngredient(ElementOfPain.Type);
        }
    }
