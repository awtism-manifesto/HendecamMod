...
{
    public class Liquidation : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            var line = new TooltipLine(Mod, "Face", "Converts darts into water darts that bounce around wildly");
            tooltips.Add(line);

            line = new TooltipLine(Mod, "Face", "'LIIIIQUIDATIIIOOOOONNNN'")
            {
