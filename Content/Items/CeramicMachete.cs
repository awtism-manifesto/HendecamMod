...
public class CeramicMachete : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<CeramicScrap>(); // ID of the projectiles the sword will shoot
        Item.shootSpeed = 5.45f; // Speed of the projectiles the sword will shoot
