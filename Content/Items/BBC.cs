...
public class BBC : ModItem
{
    ...
    public float LobotometerCost = 16f;
    ...
    {
        int NumProjectiles = Main.rand.Next(1, 20); // The number of projectiles that this gun will shoot.
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Randomly shoots between 1-20 cannonballs");
        tooltips.Add(line);
