...
public class Pyrocannon : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.knockBack = 1.25f; // Sets the item's knockback. Note that projectiles shot by this weapon will use its and the used ammunition's knockback added together.
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        for (int i = 0; i < NumProjectiles; i++)
        {
            ...
            newVelocity *= 1f - Main.rand.NextFloat(0.27f);
