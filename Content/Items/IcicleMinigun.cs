...
public class IcicleMinigun : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shoot = ProjectileType<IcicleRanged>();
    ...
    {
        type = ProjectileType<IcicleRanged>();
    }
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        for (int i = 0; i < NumProjectiles; i++)
        {
            ...
            Vector2 newVelocity = velocity.RotatedByRandom(MathHelper.ToRadians(3.85f));
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Rapidly fires freezing icicles at the target");
        tooltips.Add(line);
