...
public class LycopiteChestplate : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "4% increased damage and critical strike chance");
        tooltips.Add(line);
    ...
    {
        return head.type == ModContent.ItemType<LycopiteFedora>() && legs.type == ModContent.ItemType<LycopiteLeggings>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<LycopiteBar>(31);
