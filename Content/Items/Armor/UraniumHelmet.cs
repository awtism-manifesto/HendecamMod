...
public class UraniumHelmet : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "9% increased damage");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "-15 max life")
        {
    ...
    {
        return body.type == ItemType<UraniumChestplate>() && legs.type == ItemType<UraniumLeggings>();
    }
