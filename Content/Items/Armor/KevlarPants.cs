...
public class KevlarPants : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "9% increased critical strike chance");
        tooltips.Add(line);
    ...
    {
        return head.type == ItemType<KevlarMask>() && body.type == ItemType<KevlarBodysuit>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<Kevlar>(15);
