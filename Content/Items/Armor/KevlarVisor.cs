...
public class KevlarVisor : ModItem
{

    public static readonly int RangedCritBonus = 11;
    public static readonly int AdditiveRangedDamageBonus = 6;
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "11% increased ranged crit chance and 6% increased ranged damage");
        tooltips.Add(line);
    ...
    public override void UpdateEquip(Player player)
    {
        ...
        player.GetDamage(DamageClass.Ranged) += AdditiveRangedDamageBonus / 106f;
