...
public class PlasticChestplate : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "5% increased stupid damage");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "3% increased stupid crit chance")
        {
    ...
    public override void UpdateEquip(Player player)
    {
        ...
        player.GetDamage<StupidDamage>() += AdditiveStupidDamageBonus / 105f;
