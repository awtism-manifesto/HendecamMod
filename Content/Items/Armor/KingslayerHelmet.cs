...
public class KingslayerHelmet : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "5% increased damage and critical strike chance");
        tooltips.Add(line);
    ...
    {
        return body.type == ItemType<KingslayerBreastplate>() && legs.type == ItemType<KingslayerGreaves>();
    }
