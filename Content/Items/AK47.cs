...
public class AK47 : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.shootSpeed = 10.66f; // The speed of the projectile (measured in pixels per frame.)
    ...
    public override bool Shoot(Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
    {
        ...
        for (int i = 0; i < NumProjectiles; i++)
        {
            ...
            Vector2 newVelocity = velocity.RotatedByRandom(MathHelper.ToRadians(2.85f));
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Shoots a medium caliber bullet that pierces a little bit of enemy armor");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "'Ol' Reliable.'")
        {
