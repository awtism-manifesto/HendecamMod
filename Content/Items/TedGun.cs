...
public class TedGun : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.damage = 127; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Delivers chemical bombs to your enemies that inflict various debuffs");
        tooltips.Add(line);
