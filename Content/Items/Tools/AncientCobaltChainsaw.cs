...
public class AncientCobaltChainsaw : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.shoot = ModContent.ProjectileType<AncientCobaltChainsawProj>(); // Create the drill projectile
        ...
        Item.axe = 19; // How strong the drill is, see https://terraria.wiki.gg/wiki/Pickaxe_power for a list of common values
    }

    public override void AddRecipes()
    {
        CreateRecipe()
            .AddIngredient<AncientCobaltBar>(15)
