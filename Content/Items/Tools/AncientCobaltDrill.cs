...
public class AncientCobaltDrill : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.pick = 60; // How strong the drill is, see https://terraria.wiki.gg/wiki/Pickaxe_power for a list of common values
    }

    public override void AddRecipes()
    {
        CreateRecipe()
            .AddIngredient<AncientCobaltBar>(18)
