...
public class ParticleGun : ModItem
{
    ...
    {
        type = ModContent.ProjectileType<ParticleBeam>();
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts rockets into rapid, unstable lasers");
        tooltips.Add(line);
