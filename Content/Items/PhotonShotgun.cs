...
public class PhotonShotgun : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts musket balls into huge bursts of powerful photons that shine through almost all enemy defense");
        tooltips.Add(line);
