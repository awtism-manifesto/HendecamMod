...
internal class FireDiamondHook : ModItem
{
    ...
    {
        CreateRecipe()
            .AddIngredient<FireDiamond>(15)
            .AddTile(TileID.Anvils)
            .Register();
    }
}

internal class FireDiamondHookProj : ModProjectile
{
    ...
    {
        speed = 12; // How fast you get pulled to the grappling hook projectile's landing position
    }
