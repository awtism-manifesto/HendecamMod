...
public class CarbonDioxideBalloon : ModItem
{
    public override void SetDefaults()
    {
        Item.DefaultToAccessory(20, 26);
        Item.SetShopValues(ItemRarityColor.LightRed4, Item.buyPrice(silver: 699));
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<CarbonDioxideBottle>();
