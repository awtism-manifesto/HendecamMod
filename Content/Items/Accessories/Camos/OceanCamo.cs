...
public class OceanCamo : ModItem
{
    ...
    {
        var line = new TooltipLine(Mod, "Face", "Increases crit chance and attack speed by 10% and 5% and decreased aggro while in the Ocean biome");
        tooltips.Add(line);
