...
public class OilMonsterStaff : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.buffType = ModContent.BuffType<OilMonsterBuff>();
        // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
        Item.shoot = ModContent.ProjectileType<BabyOilMonster>(); // This item creates the minion projectile
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Summons a Mini Oil Monster to fight for you");
        tooltips.Add(line);
