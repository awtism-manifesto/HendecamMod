...
public class EbonwoodWand : ModItem
{
    ...
    {
        type = ModContent.ProjectileType<CorruptSpark>();
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        line = new TooltipLine(Mod, "Face", "Shoots a spark of corrupt energy")
        {
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient(ItemID.CorruptTorch, 10);
        ...
        recipe.AddIngredient(ItemID.CorruptTorch, 19);
