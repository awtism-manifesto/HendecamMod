...
public class PlutoniumAutoPistol : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.UseSound = SoundID.Item110; // The sound that this item plays when used.
        ...
        Item.shootSpeed = 14.9f; // The speed of the projectile (measured in pixels per frame.)
        Item.useAmmo = AmmoID.Bullet; // The "ammo Id" of the ammo item that this weapon uses. Ammo IDs are magic numbers that usually correspond to the item id of one item that most commonly represent the ammo type.
    }
    public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback)
    {
        type = ModContent.ProjectileType<Projectiles.PlutoShot>();
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts ammo into Plutonium rounds that home in after splitting");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "Ignores 20 enemy defense")
        {
