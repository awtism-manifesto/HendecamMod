...
namespace HendecamMod.Content.EmoteBubbles
{
    ...
    public abstract class ModTownEmote : ModEmoteBubble
    {
        ...
        public override string Texture => "HendecamMod/Content/EmoteBubbles/NPCEmotes";
    ...
    public class PoliticianEmote : ModTownEmote
    {
        public override int Row => 0;
    }

    public class RiverEmote : ModTownEmote
    {
        public override int Row => 1;
    }

    public class YelmutEmote : ModTownEmote
    {
        public override int Row => 2;
    }

    public class AlpineEmote : ModTownEmote
    {
