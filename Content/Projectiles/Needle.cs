...
public class Needle : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            Dust chudDust = Dust.NewDustDirect(new Vector2(Projectile.position.X + 1f + posOffsetX, Projectile.position.Y + 1f + posOffsetY) - Projectile.velocity * 0.1f, Projectile.width - 6, Projectile.height - 6, DustID.PinkTorch, 0f, 0f, 100, default, 0.25f);
            chudDust.fadeIn = 0.2f + Main.rand.Next(3) * 0.1f;
            chudDust.velocity *= 0.15f;
