...
public class RoyalSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.penetrate = 20; // The projectile can hit 3 enemies.
        ...
        Projectile.ownerHitCheckDistance = 366f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override void AI()
    {
        ...
        // }
        Lighting.AddLight(Projectile.Center, 1f, 1f, 0.35f);
        ...
        float scaleMulti = 0.805f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
        float scaleAdder = 0.975f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
        ...
        Vector2 dustPosition = Projectile.Center + dustRotation.ToRotationVector2() * 134f * Projectile.scale;
        Vector2 dustVelocity = (dustRotation + Projectile.ai[0] * MathHelper.PiOver2).ToRotationVector2();
        if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
        {
            // Original Excalibur color: Color.Gold, Color.White
            Color dustColor = Color.Lerp(Color.GhostWhite, Color.Gold, Main.rand.NextFloat() * 0.3f);
        ...
        if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
        {
            ...
            Dust.NewDustPerfect(dustPosition, DustID.TintableDustLighted, dustVelocity, 100, Color.Gold * Projectile.Opacity, 1.2f * Projectile.Opacity);
        }
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 67f * Projectile.scale;
