...
public class AzuriteSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.ownerHitCheckDistance = 109f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 57f * Projectile.scale;
