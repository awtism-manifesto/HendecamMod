...
public class BigBerthaProj : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.penetrate = 15; // The projectile can hit 3 enemies.
        ...
        Projectile.ownerHitCheckDistance = 281f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override void AI()
    {
        ...
        // }
        Lighting.AddLight(Projectile.Center, 0.85f, 0.15f, 0.25f);
        ...
        float scaleMulti = 0.75f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 60f * Projectile.scale;
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        target.AddBuff(BuffID.OnFire, 255);
        target.AddBuff(BuffID.OnFire3, 255);
    }
