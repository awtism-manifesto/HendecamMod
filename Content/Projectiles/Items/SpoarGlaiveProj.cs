...
public class SpoarGlaiveProj : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        if (HomingTarget != null && IsValidTarget(HomingTarget))
        {
            ...
            if (Projectile.timeLeft > 80)
            {
                ...
                Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(targetAngle, MathHelper.ToRadians(9.97f)).ToRotationVector2() * length;
