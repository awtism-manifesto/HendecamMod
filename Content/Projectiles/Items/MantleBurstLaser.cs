...
public class MantleBurstLaser : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int j = 0; j < 11; j++)
        {
            Dust fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.RedTorch, 0f, 0f, 100, default, 1.3f);
            fireDust.noGravity = true;
            fireDust.velocity *= 5.5f;
            fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.RedTorch, 0f, 0f, 100, default, 1.3f);
            fireDust.velocity *= 6f;
            Dust RubyDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.RedTorch, 0f, 0f, 100, default, 1.3f);
            RubyDust.noGravity = true;
            RubyDust.velocity *= 4f;
            RubyDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.RedTorch, 0f, 0f, 100, default, 1.3f);
            RubyDust.velocity *= 5.25f;
        }
    }
