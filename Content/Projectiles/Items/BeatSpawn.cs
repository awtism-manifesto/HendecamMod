...
public class BeatSpawn : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            Projectile.NewProjectile(
                ...
                position,
                velocity,
                ModContent.ProjectileType<TransBeamBlue>(),
                Projectile.damage,
        ...
        for (int i = 0; i < 4; i++)
        {
            float rotation = MathHelper.ToRadians(i * 90f + 45f);
            Vector2 velocity = Projectile.velocity.RotatedBy(rotation);
            Vector2 position = Projectile.Center;
            ...
            Projectile.NewProjectile(
                ...
                position,
                velocity,
                ModContent.ProjectileType<TransBeamPink>(),
                Projectile.damage,
                Projectile.knockBack,
                Projectile.owner
            );
