...
public class CrystalGelShard : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.DamageType = GetInstance<MeleeRangedDamage>(); // Is the projectile shoot by a ranged weapon?
        Projectile.penetrate = 1; // How many monsters the projectile can penetrate. (OnTileCollide below also decrements penetrate for bounces as well)
        Projectile.timeLeft = 390; // The live time for the projectile (60 = 1 second, so 600 is 10 seconds)
    ...
    public override void AI()
    {
        ...
        Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(targetAngle, MathHelper.ToRadians(3.33f)).ToRotationVector2() * length;
