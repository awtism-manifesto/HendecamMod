...
public class CiaSpawn : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits, velocity,
            ProjectileType<CiaShot2>(), (int)(Projectile.damage * 0.5f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits2, velocity2,
            ProjectileType<CiaShot3>(), (int)(Projectile.damage * 0.33f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits3, velocity3,
            ProjectileType<CiaShot>(), (int)(Projectile.damage * 0.67f), Projectile.knockBack, Projectile.owner);
