...
public class DragonSpawn : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits, velocity,
            ModContent.ProjectileType<DragonBreath>(), (int)(Projectile.damage * 0.375f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits5, velocity5,
            ModContent.ProjectileType<DragonBreath2>(), (int)(Projectile.damage * 0.375f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits9, velocity9,
            ModContent.ProjectileType<DragonBreath3>(), (int)(Projectile.damage * 0.375f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits12, velocity12,
            ModContent.ProjectileType<DragonBreath4>(), (int)(Projectile.damage * 0.375f), Projectile.knockBack, Projectile.owner);
