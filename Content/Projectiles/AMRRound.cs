...
public class AMRRound : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.penetrate = 3; // Infinite penetration so that the blast can hit all enemies within its radius.
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits,
            ...
            ProjectileType<BoomSmall>(), (int)(Projectile.damage * 0.67), Projectile.knockBack, Projectile.owner);
    }
