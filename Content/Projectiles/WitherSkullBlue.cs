...
public class WitherSkullBlue : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        Projectile.Resize(232, 232);

        // Spawn a bunch of smoke dusts.
        for (int i = 0; i < 10; i++)
        {
            Dust smokeDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, Color.DarkTurquoise, 1.5f);
            smokeDust.velocity *= 3.5f;
            smokeDust.noGravity = true;
            Dust smoke3Dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, Color.DarkTurquoise, 1.5f);
