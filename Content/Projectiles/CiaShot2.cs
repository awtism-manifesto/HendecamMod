...
public class CiaShot2 : ModProjectile
{
    public override void SetStaticDefaults()
    {
        ProjectileID.Sets.TrailCacheLength[Projectile.type] = 32; // The length of old position to be recorded
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.light = 0.99f; // How much light emit around the projectile
