...
public class MerFlare2 : ModProjectile
{
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits,
            ...
            ProjectileType<MinieProj>(), (int)(Projectile.damage * 0.95f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Im,
            ...
            ProjectileType<MinieProj>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
