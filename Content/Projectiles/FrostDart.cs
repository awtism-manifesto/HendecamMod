...
public class FrostDart : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            Dust fireDust = Dust.NewDustDirect(new Vector2(Projectile.position.X + 1f + posOffsetX, Projectile.position.Y + 1f + posOffsetY) - Projectile.velocity * 0.1f, Projectile.width - 5, Projectile.height - 5, DustID.IceTorch, 0f, 0f, 100, default, 0.3f);
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits, velocity,
            ProjectileType<FrostChunk>(), (int)(Projectile.damage * 0.3f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits3, velocity3,
            ProjectileType<FrostBoom>(), (int)(Projectile.damage * 0.4f), Projectile.knockBack, Projectile.owner);
