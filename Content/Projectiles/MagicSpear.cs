...
public class MagicSpear : ModProjectile
{
    ...
    protected virtual float HoldoutRangeMin => 45f;
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        for (int j = 0; j < 8; j++)
        {
            Dust fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.WaterCandle, 0f, 0f, 100, default, 1.5f);
            fireDust.noGravity = true;
            fireDust.velocity *= 9.6f;
