...
public class MantleSwing : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        float scaleMulti = 0.85f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 62f * Projectile.scale;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color backDarkColor = new Color(135, 15, 55); // Original Excalibur color: Color(180, 160, 60)
        Color middleMediumColor = new Color(185, 45, 75); // Original Excalibur color: Color(255, 255, 80)
        Color frontLightColor = new Color(255, 75, 115); // Original Excalibur color: Color(255, 240, 150)
