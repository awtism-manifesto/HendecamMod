...
namespace HendecamMod.Content.Projectiles.Friendly.Summon;


public class ParagonMeteor : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.width = 93; // The width of projectile hitbox
        Projectile.height = 93; // The height of projectile hitbox
    ...
    public override void AI()
    {
        ...
        Lighting.AddLight(Projectile.Center, 0.25f, 0.5f, 2.35f);
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            Dust chudDust = Dust.NewDustDirect(new Vector2(Projectile.position.X + 1f + posOffsetX, Projectile.position.Y + 1f + posOffsetY) - Projectile.velocity * 0.1f, Projectile.width - 7, Projectile.height - 7, DustID.BlueTorch, 0f, 0f, 100, default, 0.25f);
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        for (int i = 0; i < 16; i++) // Creates a splash of dust around the position the projectile dies.
        {
            ...
            dust.velocity *= 18.5f;
            dust.scale *= 4.5f;
            Dust dust2 = Dust.NewDustDirect(target.position, target.width, target.height, DustID.BlueTorch);
            dust2.noGravity = true;
            dust2.velocity *= 18.5f;
            dust2.scale *= 4.5f;
        }
