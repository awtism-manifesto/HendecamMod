...
public class DemoniteShurikenProjectile : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        {
            Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Demonite);
            dust.noGravity = true;
            dust.velocity *= 1.5f;
            dust.scale *= 0.9f;
        }
