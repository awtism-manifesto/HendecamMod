...
public class WitherSkullBlack : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            smokeDust.velocity *= 4.5f;
            smokeDust.noGravity = true;
            Dust smoke3Dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 1.5f);
            smoke3Dust.velocity *= 3.25f;
        }
