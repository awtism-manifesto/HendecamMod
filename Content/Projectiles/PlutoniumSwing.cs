...
public class PlutoniumSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.penetrate = 11; // The projectile can hit 3 enemies.
        Projectile.usesLocalNPCImmunity = true;
        Projectile.localNPCHitCooldown = 38;
    ...
    public override void AI()
    {
        ...
        float scaleMulti = 0.95f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
        float scaleAdder = 0.95f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
        ...
        Vector2 dustPosition = Projectile.Center + dustRotation.ToRotationVector2() * 96f * Projectile.scale;
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 65f * Projectile.scale;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color backDarkColor = new Color(175, 91, 245); // Original Excalibur color: Color(180, 160, 60)
        Color middleMediumColor = new Color(175, 91, 245); // Original Excalibur color: Color(255, 255, 80)
        Color frontLightColor = new Color(175, 91, 245); // Original Excalibur color: Color(255, 240, 150)

        Color whiteTimesLerpTime = Color.Purple * lerpTime * 0.5f;
