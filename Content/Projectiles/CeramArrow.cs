...
public class CeramArrow : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits,
            ...
            ProjectileType<CeramNop>(), Projectile.damage = (int)(Projectile.damage * 0.275f), Projectile.knockBack, Projectile.owner);
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), JorkinMy,
            ...
            ProjectileType<CeramNop>(), Projectile.damage = (int)(Projectile.damage * 0.999f), Projectile.knockBack, Projectile.owner);
