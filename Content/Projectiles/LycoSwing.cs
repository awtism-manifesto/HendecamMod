...
namespace HendecamMod.Content.Projectiles
{
    ...
    public class LycoSwing : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // }
            Lighting.AddLight(Projectile.Center, 0.9f, 0.67f, 0.15f);
            ...
            float scaleMulti = 0.825f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
            float scaleAdder = 0.925f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
