...
public class ChainThunder2 : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        float maxDetectRadius = 13000f; // The maximum radius at which a projectile can detect a target
        ...
        Projectile.velocity = Projectile.velocity.ToRotation().AngleTowards(targetAngle, MathHelper.ToRadians(15f)).ToRotationVector2() * length;
    }
