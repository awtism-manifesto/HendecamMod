...
public class MarbleSwing : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        float scaleMulti = 1.05f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
        float scaleAdder = 1.25f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
