...
public class BushPlane : ModProjectile
{
    ...
    public override void OnKill(int timeLeft)
    {
        ...
        for (int j = 0; j < 25; j++)
        {
            Dust fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Smoke, 0f, 0f, 100, default, 3.5f);
            fireDust.noGravity = true;
            fireDust.velocity *= 3f;
