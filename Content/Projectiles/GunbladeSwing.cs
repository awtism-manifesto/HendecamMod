...
public class GunbladeSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.ownerHitCheckDistance = 169f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override void AI()
    {
        ...
        float scaleMulti = 0.9f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        float coneLength = 69f * Projectile.scale;
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color whiteTimesLerpTime = Color.Blue * lerpTime * 0.5f;
