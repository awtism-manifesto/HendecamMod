...
public class AstaSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.penetrate = 8; // The projectile can hit 3 enemies.
        ...
        Projectile.ownerHitCheckDistance = 176f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override void AI()
    {
        ...
        // }
        Lighting.AddLight(Projectile.Center, 1f, 0.25f, 0.4f);
        ...
        float scaleMulti = 1.35f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
        float scaleAdder = 1.35f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color backDarkColor = new Color(241, 44, 91); // Original Excalibur color: Color(180, 160, 60)
        Color middleMediumColor = new Color(246, 46, 96); // Original Excalibur color: Color(255, 255, 80)
        Color frontLightColor = new Color(252, 49, 99); // Original Excalibur color: Color(255, 240, 150)
