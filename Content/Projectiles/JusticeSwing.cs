...
namespace HendecamMod.Content.Projectiles
{
    ...
    public class JusticeSwing : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.penetrate = 9; // The projectile can hit 3 enemies.
            ...
            Projectile.ownerHitCheckDistance = 156f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
        ...
        public override void AI()
        {
            ...
            // }
            Lighting.AddLight(Projectile.Center, 1f, 0.33f, 0.33f);
            ...
            float scaleMulti = 0.81f; // Excalibur, Terra Blade, and The Horseman's Blade is 0.6f; True Excalibur is 1f; default is 0.2f 
            float scaleAdder = 0.86f; // Excalibur, Terra Blade, and The Horseman's Blade is 1f; True Excalibur is 1.2f; default is 1f 
