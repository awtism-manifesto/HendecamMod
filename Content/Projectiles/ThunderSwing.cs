...
public class ThunderSwing : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        Projectile.ownerHitCheckDistance = 180f; // The maximum range that the projectile can hit a target. 300 pixels is 18.75 tiles.
    ...
    public override void AI()
    {
        ...
        // }
        Lighting.AddLight(Projectile.Center, 0.33f, 0.67f, 0.95f);
    ...
    public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
    {
        ...
        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Peanits2, velocity2,
            ProjectileType<ChainThunder>(), (int)(Projectile.damage * 0.8f), Projectile.knockBack, Projectile.owner);
    }
    ...
    public override bool PreDraw(ref Color lightColor)
    {
        ...
        Color backDarkColor = new Color(77, 178, 255); // Original Excalibur color: Color(180, 160, 60)
        Color middleMediumColor = new Color(251, 251, 255); // Original Excalibur color: Color(255, 255, 80)
        Color frontLightColor = new Color(252, 109, 240); // Original Excalibur color: Color(255, 240, 150)
