...
public class SteelShortswordProj : ModProjectile
{
    ...
    {
        Projectile.Size = new Vector2(15); // This sets width and height to the same value (important when projectiles can rotate)
    ...
    public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
    {
        ...
        Vector2 start = Projectile.Center;
        Vector2 end = start + Projectile.velocity * 6.33f;
