    ...
    public override void AI()
    {
        ...
        if (Projectile.alpha < 167)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                Dust fire2Dust = Dust.NewDustDirect(new Vector2(Projectile.position.X + 1f + posOffsetX, Projectile.position.Y + 1f + posOffsetY) - Projectile.velocity * 0.1f, Projectile.width - 13, Projectile.height - 13, DustID.Gastropod, 0f, 0f, 100, default, 1.45f);
