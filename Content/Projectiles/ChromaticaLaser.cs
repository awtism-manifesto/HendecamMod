...
{
    public class ChromaticaLaser : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int j = 0; j < 13; j++)
            {
                Dust fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.GemEmerald, 0f, 0f, 100, default, 1.3f);
                fireDust.noGravity = true;
                fireDust.velocity *= 10.5f;
                fireDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.GemEmerald, 0f, 0f, 100, default, 1.3f);
                fireDust.velocity *= 9f;
                Dust RubyDust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.GemRuby, 0f, 0f, 100, default, 1.3f);
                RubyDust.noGravity = true;
                RubyDust.velocity *= 10.5f;
