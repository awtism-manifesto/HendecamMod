...
{
    public const int FadeInDuration = 14;
    ...
    {
        Projectile.Size = new Vector2(1); // This sets width and height to the same value (important when projectiles can rotate)
        ...
        Projectile.extraUpdates = 2; // Update 1+extraUpdates times per tick
