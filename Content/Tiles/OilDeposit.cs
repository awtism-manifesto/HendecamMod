    ...
    public class OilDeposit : ModTile
    {
        ...
        public class FrozenOilSystem : ModSystem
        {
            ...
            public override void ModifyWorldGenTasks(List<GenPass> tasks, ref double totalWeight)
            {
                ...
                if (ShiniesIndex != -1)
                {
                    ...
                    tasks.Insert(ShiniesIndex + 1, new MagnoliaOrePass("Oil Deposits", 237.4298f));
                }
            }
        }
        ...
        public class MagnoliaOrePass : GenPass
        {
            ...
            protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
            {
                ...
                progress.Message = FrozenOilSystem.MagnoliaOrePassMessage.Value;
                ...
                for (int k = 0; k < (int)(Main.maxTilesX * Main.maxTilesY * 12E-05); k++)
                {
                    ...
                    WorldGen.TileRunner(x, y, WorldGen.genRand.Next(4, 7), WorldGen.genRand.Next(4, 7), ModContent.TileType<OilDeposit>());
