...
{
    public class TransOrePlaced : ModTile
    {
        public override void SetStaticDefaults()
        {
            TileID.Sets.Ore[Type] = true;
            Main.tileSpelunker[Type] = true; // The tile will be affected by spelunker highlighting
            Main.tileOreFinderPriority[Type] = 450; // Metal Detector value, see https://terraria.wiki.gg/wiki/Metal_Detector
        ...
        public class TransOreSystem : ModSystem
        {
        ...
        public class MagnoliaOrePass : GenPass
        {
            ...
            protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
            {
                ...
                progress.Message = TransOreSystem.MagnoliaOrePassMessage.Value;
