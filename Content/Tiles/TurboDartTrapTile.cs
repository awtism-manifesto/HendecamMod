    ...
    public override void HitWire(int i, int j)
    {
        ...
        if (style == 0)
        {
            ...
            if (Wiring.CheckMech(i, j, 15))
            {
                ...
                Projectile.NewProjectile(Wiring.GetProjectileSource(i, j), spawnPosition, new Vector2(horizontalDirection, verticalDirection) * 6.66f, ProjectileType<CarbonFiberDart>(), 55, 2.5f, Main.myPlayer);
            }
        }
    }
}