...
namespace HendecamMod.Content.GlobalNPCs
{
    ...
    public class TownNpeeRespawnSystem : ModSystem
    {
        ...
        public override void SaveWorldData(TagCompound tag)
        {
            tag[nameof(unlockedriver)] = unlockedriver;
        }

        public override void LoadWorldData(TagCompound tag)
        {
            unlockedriver = tag.GetBool(nameof(unlockedriver));
        ...
        public override void NetSend(BinaryWriter writer)
        {
            writer.WriteFlags(unlockedriver);
        }
    ...
    public class YelmutRespawnSystem : ModSystem
    {
        ...
        public override void ClearWorld()
        {
            unlockedyelmut = false;
        }

        public override void SaveWorldData(TagCompound tag)
        {
            tag[nameof(unlockedyelmut)] = unlockedyelmut;
        }

        public override void LoadWorldData(TagCompound tag)
        {
            unlockedyelmut = tag.GetBool(nameof(unlockedyelmut));
        ...
        public override void NetSend(BinaryWriter writer)
        {
            writer.WriteFlags(unlockedyelmut);
        }

        public override void NetReceive(BinaryReader reader)
        {
            reader.ReadFlags(out unlockedyelmut);
        }
    }
}