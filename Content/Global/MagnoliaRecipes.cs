...
namespace HendecamMod.Content.Global
{
    public class MagnoliaRecipes : ModSystem
    {
        public override void AddRecipes()
        {
            ...
            A191.AddIngredient(ItemID.IlluminantHook, 1);
            ...
            A172.AddIngredient<FireDiamond>(1);
            A172.Register();
            ...
            A185.AddIngredient<Paper>(1);
            A185.Register();

            Recipe A186 = Recipe.Create(ItemID.PaperAirplaneB, 2);
            A186.AddIngredient<Paper>(1);
            A186.Register();
            ...
            A40.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A40.Register();

            Recipe A41 = Recipe.Create(ItemID.NinjaHood);
            A41.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A41.Register();

            Recipe A42 = Recipe.Create(ItemID.NinjaShirt);
            A42.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A42.Register();

            Recipe A43 = Recipe.Create(ItemID.NinjaPants);
            A43.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A43.Register();

            Recipe A44 = Recipe.Create(ItemID.SlimeHook);
            A44.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A44.Register();

            Recipe A45 = Recipe.Create(ItemID.SlimeGun);
            A45.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A45.Register();

            Recipe A46 = Recipe.Create(ItemID.KingSlimeMask);
            A46.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A46.Register();

            Recipe A47 = Recipe.Create(ItemID.KingSlimeTrophy);
            A47.AddIngredient<Items.Icons.KingSlimeIcon>(1);
            A47.Register();

            Recipe A48 = Recipe.Create(ItemID.Binoculars);
            A48.AddIngredient<Items.Icons.EyeOfCthulhuIcon>(1);
            A48.Register();

            Recipe A49 = Recipe.Create(ItemID.EyeMask);
            A49.AddIngredient<Items.Icons.EyeOfCthulhuIcon>(1);
            A49.Register();

            Recipe A50 = Recipe.Create(ItemID.EyeofCthulhuTrophy);
            A50.AddIngredient<Items.Icons.EyeOfCthulhuIcon>(1);
            A50.Register();

            Recipe A51 = Recipe.Create(ItemID.EatersBone);
            A51.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A51.Register();

            Recipe A52 = Recipe.Create(ItemID.EaterMask);
            A52.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A52.Register();

            Recipe A53 = Recipe.Create(ItemID.EaterofWorldsTrophy);
            A53.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A53.Register();

            Recipe A54 = Recipe.Create(ItemID.BoneRattle);
            A54.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A54.Register();

            Recipe A55 = Recipe.Create(ItemID.BrainMask);
            A55.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A55.Register();

            Recipe A56 = Recipe.Create(ItemID.BrainofCthulhuTrophy);
            A56.AddIngredient<Items.Icons.EaterOfWorldsIcon>(1);
            A56.Register();

            Recipe A57 = Recipe.Create(ItemID.BeeGun);
            A57.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A57.Register();

            Recipe A58 = Recipe.Create(ItemID.BeeKeeper);
            A58.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A58.Register();

            Recipe A59 = Recipe.Create(ItemID.BeesKnees);
            A59.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A59.Register();

            Recipe A60 = Recipe.Create(ItemID.HiveWand);
            A60.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A60.Register();

            Recipe A61 = Recipe.Create(ItemID.BeeHat);
            A61.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A61.Register();

            Recipe A62 = Recipe.Create(ItemID.BeeShirt);
            A62.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A62.Register();

            Recipe A63 = Recipe.Create(ItemID.BeePants);
            A63.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A63.Register();

            Recipe A64 = Recipe.Create(ItemID.HoneyComb);
            A64.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A64.Register();

            Recipe A65 = Recipe.Create(ItemID.Nectar);
            A65.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A65.Register();

            Recipe A66 = Recipe.Create(ItemID.HoneyedGoggles);
            A66.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A66.Register();

            Recipe A67 = Recipe.Create(ItemID.Beenade, 30);
            A67.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A67.Register();

            Recipe A68 = Recipe.Create(ItemID.BeeMask);
            A68.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A68.Register();

            Recipe A69 = Recipe.Create(ItemID.QueenBeeTrophy);
            A69.AddIngredient<Items.Icons.QueenBeeIcon>(1);
            A69.Register();

            Recipe A70 = Recipe.Create(ItemID.SkeletronMask);
            A70.AddIngredient<Items.Icons.SkeletronIcon>(1);
            A70.Register();

            Recipe A71 = Recipe.Create(ItemID.SkeletronHand);
            A71.AddIngredient<Items.Icons.SkeletronIcon>(1);
            A71.Register();

            Recipe A72 = Recipe.Create(ItemID.BookofSkulls);
            A72.AddIngredient<Items.Icons.SkeletronIcon>(1);
            A72.Register();

            Recipe A73 = Recipe.Create(ItemID.SkeletronTrophy);
            A73.AddIngredient<Items.Icons.SkeletronIcon>(1);
            A73.Register();

            Recipe A74 = Recipe.Create(ItemID.ChippysCouch);
            A74.AddIngredient<Items.Icons.SkeletronIcon>(1);
            A74.Register();

            Recipe A75 = Recipe.Create(ItemID.ChesterPetItem);
            A75.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A75.Register();

            Recipe A76 = Recipe.Create(ItemID.Eyebrella);
            A76.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A76.Register();

            Recipe A77 = Recipe.Create(ItemID.DizzyHat);
            A77.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A77.Register();

            Recipe A78 = Recipe.Create(ItemID.PewMaticHorn);
            A78.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A78.Register();

            Recipe A79 = Recipe.Create(ItemID.WeatherPain);
            A79.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A79.Register();

            Recipe A80 = Recipe.Create(ItemID.LucyTheAxe);
            A80.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A80.Register();

            Recipe A81 = Recipe.Create(ItemID.DeerclopsMask);
            A81.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A81.Register();

            Recipe A82 = Recipe.Create(ItemID.DeerclopsTrophy);
            A82.AddIngredient<Items.Icons.DeerclopsIcon>(1);
            A82.Register();

            Recipe A83 = Recipe.Create(ItemID.BreakerBlade);
            A83.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A83.Register();

            Recipe A84 = Recipe.Create(ItemID.ClockworkAssaultRifle);
            A84.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A84.Register();

            Recipe A85 = Recipe.Create(ItemID.LaserRifle);
            A85.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A85.Register();

            Recipe A86 = Recipe.Create(ItemID.FireWhip);
            A86.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A86.Register();

            Recipe A87 = Recipe.Create(ItemID.WarriorEmblem);
            A87.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A87.Register();

            Recipe A88 = Recipe.Create(ItemID.RangerEmblem);
            A88.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A88.Register();

            Recipe A89 = Recipe.Create(ItemID.SorcererEmblem);
            A89.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A89.Register();

            Recipe A90 = Recipe.Create(ItemID.SummonerEmblem);
            A90.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A90.Register();

            Recipe A91 = Recipe.Create(ItemID.FleshMask);
            A91.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A91.Register();

            Recipe A92 = Recipe.Create(ItemID.WallofFleshTrophy);
            A92.AddIngredient<Items.Icons.WallOfFleshIcon>(1);
            A92.Register();

            Recipe A93 = Recipe.Create(ItemID.CrystalNinjaHelmet);
            A93.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A93.Register();

            Recipe A94 = Recipe.Create(ItemID.CrystalNinjaChestplate);
            A94.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A94.Register();

            Recipe A95 = Recipe.Create(ItemID.CrystalNinjaLeggings);
            A95.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A95.Register();

            Recipe A96 = Recipe.Create(ItemID.Smolstar);
            A96.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A96.Register();

            Recipe A97 = Recipe.Create(ItemID.QueenSlimeMountSaddle);
            A97.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A97.Register();

            Recipe A98 = Recipe.Create(ItemID.QueenSlimeHook);
            A98.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A98.Register();

            Recipe A99 = Recipe.Create(ItemID.QueenSlimeMask);
            A99.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A99.Register();

            Recipe A100 = Recipe.Create(ItemID.QueenSlimeTrophy);
            A100.AddIngredient<Items.Icons.QueenSlimeIcon>(1);
            A100.Register();

            Recipe A101 = Recipe.Create(ItemID.TwinMask);
            A101.AddIngredient<Items.Icons.TheTwinsIcon>(1);
            A101.Register();

            Recipe A102 = Recipe.Create(ItemID.RetinazerTrophy);
            A102.AddIngredient<Items.Icons.TheTwinsIcon>(1);
            A102.Register();

            Recipe A103 = Recipe.Create(ItemID.SpazmatismTrophy);
            A103.AddIngredient<Items.Icons.TheTwinsIcon>(1);
            A103.Register();

            Recipe A104 = Recipe.Create(ItemID.DestroyerMask);
            A104.AddIngredient<Items.Icons.TheDestroyerIcon>(1);
            A104.Register();

            Recipe A105 = Recipe.Create(ItemID.DestroyerTrophy);
            A105.AddIngredient<Items.Icons.TheDestroyerIcon>(1);
            A105.Register();

            Recipe A106 = Recipe.Create(ItemID.SkeletronPrimeMask);
            A106.AddIngredient<Items.Icons.SkeletronPrimeIcon>(1);
            A106.Register();

            Recipe A107 = Recipe.Create(ItemID.SkeletronPrimeTrophy);
            A107.AddIngredient<Items.Icons.SkeletronPrimeIcon>(1);
            A107.Register();

            Recipe A108 = Recipe.Create(ItemID.VenusMagnum);
            A108.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A108.Register();

            Recipe A109 = Recipe.Create(ItemID.NettleBurst);
            A109.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A109.Register();

            Recipe A110 = Recipe.Create(ItemID.LeafBlower);
            A110.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A110.Register();

            Recipe A111 = Recipe.Create(ItemID.FlowerPow);
            A111.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A111.Register();

            Recipe A112 = Recipe.Create(ItemID.WaspGun);
            A112.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A112.Register();

            Recipe A113 = Recipe.Create(ItemID.Seedler);
            A113.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A113.Register();

            Recipe A114 = Recipe.Create(ItemID.PygmyStaff);
            A114.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A114.Register();

            Recipe A115 = Recipe.Create(ItemID.ThornHook);
            A115.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A115.Register();

            Recipe A116 = Recipe.Create(ItemID.TheAxe);
            A116.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A116.Register();

            Recipe A117 = Recipe.Create(ItemID.Seedling);
            A117.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A117.Register();

            Recipe A118 = Recipe.Create(ItemID.PlanteraMask);
            A118.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A118.Register();

            Recipe A119 = Recipe.Create(ItemID.PlanteraTrophy);
            A119.AddIngredient<Items.Icons.PlanteraIcon>(1);
            A119.Register();

            Recipe A120 = Recipe.Create(ItemID.Picksaw);
            A120.AddIngredient<Items.Icons.GolemIcon>(1);
            A120.Register();

            Recipe A121 = Recipe.Create(ItemID.Stynger);
            A121.AddIngredient<Items.Icons.GolemIcon>(1);
            A121.Register();

            Recipe A122 = Recipe.Create(ItemID.StyngerBolt, 100);
            A122.AddIngredient<Items.Icons.GolemIcon>(1);
            A122.Register();

            Recipe A123 = Recipe.Create(ItemID.PossessedHatchet);
            A123.AddIngredient<Items.Icons.GolemIcon>(1);
            A123.Register();

            Recipe A124 = Recipe.Create(ItemID.SunStone);
            A124.AddIngredient<Items.Icons.GolemIcon>(1);
            A124.Register();

            Recipe A125 = Recipe.Create(ItemID.EyeoftheGolem);
            A125.AddIngredient<Items.Icons.GolemIcon>(1);
            A125.Register();

            Recipe A126 = Recipe.Create(ItemID.HeatRay);
            A126.AddIngredient<Items.Icons.GolemIcon>(1);
            A126.Register();

            Recipe A127 = Recipe.Create(ItemID.StaffofEarth);
            A127.AddIngredient<Items.Icons.GolemIcon>(1);
            A127.Register();

            Recipe A128 = Recipe.Create(ItemID.GolemFist);
            A128.AddIngredient<Items.Icons.GolemIcon>(1);
            A128.Register();

            Recipe A129 = Recipe.Create(ItemID.GolemMask);
            A129.AddIngredient<Items.Icons.GolemIcon>(1);
            A129.Register();

            Recipe A130 = Recipe.Create(ItemID.GolemTrophy);
            A130.AddIngredient<Items.Icons.GolemIcon>(1);
            A130.Register();

            Recipe A131 = Recipe.Create(ItemID.FairyQueenMagicItem);
            A131.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A131.Register();

            Recipe A132 = Recipe.Create(ItemID.PiercingStarlight);
            A132.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A132.Register();

            Recipe A133 = Recipe.Create(ItemID.RainbowWhip);
            A133.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A133.Register();

            Recipe A134 = Recipe.Create(ItemID.FairyQueenRangedItem);
            A134.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A134.Register();

            Recipe A135 = Recipe.Create(ItemID.RainbowWings);
            A135.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A135.Register();

            Recipe A136 = Recipe.Create(ItemID.HallowBossDye);
            A136.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A136.Register();

            Recipe A137 = Recipe.Create(ItemID.SparkleGuitar);
            A137.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A137.Register();

            Recipe A138 = Recipe.Create(ItemID.RainbowCursor);
            A138.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A138.Register();

            Recipe A139 = Recipe.Create(ItemID.FairyQueenMask);
            A139.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A139.Register();

            Recipe A140 = Recipe.Create(ItemID.FairyQueenTrophy);
            A140.AddIngredient<Items.Icons.EmpressOfLightIcon>(1);
            A140.Register();

            Recipe A141 = Recipe.Create(ItemID.BubbleGun);
            A141.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A141.Register();

            Recipe A142 = Recipe.Create(ItemID.Flairon);
            A142.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A142.Register();

            Recipe A143 = Recipe.Create(ItemID.RazorbladeTyphoon);
            A143.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A143.Register();

            Recipe A144 = Recipe.Create(ItemID.TempestStaff);
            A144.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A144.Register();

            Recipe A145 = Recipe.Create(ItemID.Tsunami);
            A145.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A145.Register();

            Recipe A146 = Recipe.Create(ItemID.FishronWings);
            A146.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A146.Register();

            Recipe A147 = Recipe.Create(ItemID.DukeFishronMask);
            A147.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A147.Register();

            Recipe A148 = Recipe.Create(ItemID.DukeFishronTrophy);
            A148.AddIngredient<Items.Icons.DukeFishronIcon>(1);
            A148.Register();

            Recipe A149 = Recipe.Create(ItemID.BossMaskCultist);
            A149.AddIngredient<Items.Icons.LunaticCultistIcon>(1);
            A149.Register();

            Recipe A150 = Recipe.Create(ItemID.AncientCultistTrophy);
            A150.AddIngredient<Items.Icons.LunaticCultistIcon>(1);
            A150.Register();

            Recipe A151 = Recipe.Create(ItemID.Meowmere);
            A151.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A151.Register();

            Recipe A152 = Recipe.Create(ItemID.Terrarian);
            A152.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A152.Register();

            Recipe A153 = Recipe.Create(ItemID.StarWrath);
            A153.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A153.Register();

            Recipe A154 = Recipe.Create(ItemID.SDMG);
            A154.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A154.Register();

            Recipe A155 = Recipe.Create(ItemID.Celeb2);
            A155.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A155.Register();

            Recipe A156 = Recipe.Create(ItemID.LastPrism);
            A156.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A156.Register();

            Recipe A157 = Recipe.Create(ItemID.LunarFlareBook);
            A157.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A157.Register();

            Recipe A158 = Recipe.Create(ItemID.RainbowCrystalStaff);
            A158.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A158.Register();

            Recipe A159 = Recipe.Create(ItemID.MoonlordTurretStaff);
            A159.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A159.Register();

            Recipe A160 = Recipe.Create(ItemID.BossMaskMoonlord);
            A160.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A160.Register();

            Recipe A161 = Recipe.Create(ItemID.MoonLordTrophy);
            A161.AddIngredient<Items.Icons.MoonLordIcon>(1);
            A161.Register();
            ...
            A195.AddIngredient(ItemID.SoulofLight, 1);
