...
public class MintalSystem : ModSystem
{
    ...
    public void BlessWorldWithMintal()
    {
        ...
        ThreadPool.QueueUserWorkItem(_ =>
        {
            ...
            int splotches = (int)(246 * (Main.maxTilesX / 4200f));
            int highestY = (int)Utils.Lerp(Main.worldSurface, Main.UnderworldLayer, 0.395);
            for (int iteration = 0; iteration < splotches; iteration++)
            {
                ...
                WorldGen.OreRunner(i, j, WorldGen.genRand.Next(4, 6), WorldGen.genRand.Next(7, 8), (ushort)TileType<MintalOrePlaced>());
            }
        });
    }
