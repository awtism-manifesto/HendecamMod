...
public class PlutoniumSystem : ModSystem
{
    ...
    public void BlessWorldWithPlutonium()
    {
        ...
        ThreadPool.QueueUserWorkItem(_ =>
        {
            ...
            {
                ChatHelper.BroadcastChatMessage(PlutoniumBlessMessage.ToNetworkText(), new Color(115, 25, 255));
            }
            ...
            for (int iteration = 0; iteration < splotches; iteration++)
            {
                ...
                WorldGen.OreRunner(i, j, WorldGen.genRand.Next(6, 7), WorldGen.genRand.Next(7, 8), (ushort)ModContent.TileType<PlutoniumOrePlaced>());
            }
        });
    }
