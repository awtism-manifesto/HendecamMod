...
public class ExampleNPCLoot : GlobalNPC
{
    ...
    public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
    {
        if (npc.type == NPCID.PirateShip)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<ScreamingSoyjak>(), chanceDenominator: 30));
        ...
        if (npc.type == NPCID.PirateCorsair)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<ScreamingSoyjak>(), chanceDenominator: 45));
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Shadowflame>(), 1, 21, 41));

            npcLoot.Add(ItemDropRule.Common(ItemID.TatteredCloth, 2, 4, 12));
            npcLoot.Add(ItemDropRule.Common(ItemID.GoblinBattleStandard, 1, 1, 1));
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<BadGrades>(), chanceDenominator: 50));
            npcLoot.Add(ItemDropRule.Common(ItemID.Handgun, 10000));
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<BadGrades>(), chanceDenominator: 50));
            npcLoot.Add(ItemDropRule.Common(ItemID.Handgun, 9999));
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Libeerator>(), chanceDenominator: 30));
        ...
        if (npc.type == NPCID.SandShark)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SandyScorpion>(), chanceDenominator: 20));
        ...
        if (npc.type == NPCID.SandsharkHallow)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SandyScorpion>(), chanceDenominator: 19));


        }
        if (npc.type == NPCID.DungeonSlime)
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Liquidation>(), chanceDenominator: 25));
        ...
        if (npc.type == NPCID.SantaNK1)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Bergentrucking>(), chanceDenominator: 9));
        ...
        if (npc.type == NPCID.KingSlime)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Bergentrucking>(), chanceDenominator: 5));
        ...
        if (npc.type == NPCID.DD2OgreT2)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<TrenboloneAcetate>(), chanceDenominator: 3));
        ...
        if (npc.type == NPCID.DD2OgreT3)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<TrenboloneAcetate>(), chanceDenominator: 5));
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<CaribousCatastrophe>(), chanceDenominator: 3));
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<FlinxsFurblade>(), chanceDenominator: 3));
