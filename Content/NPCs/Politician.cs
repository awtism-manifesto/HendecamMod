...
namespace HendecamMod.Content.NPCs
{
    ...
    public class Politician : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPCID.Sets.AttackTime[Type] = 11; // The amount of time it takes for the NPC's attack animation to be over once it starts.
            ...
            NPC.Happiness
                ...
                .SetNPCAffection(NPCID.Demolitionist, AffectionLevel.Like) // Hates living near the demolitionist.
            ; // < Mind the semicolon!
