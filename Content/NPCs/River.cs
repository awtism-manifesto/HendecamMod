    ...
    public class River : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.Happiness
                ...
                .SetNPCAffection(NPCID.Pirate, AffectionLevel.Like) // Hates living near the demolitionist.
            ; // < Mind the semicolon!
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
				...
				new FlavorTextBestiaryInfoElement("\"They have no rules, no boundaries. They don't flinch at torture, human trafficking or genocide. They're not loyal to a country or a flag or any set of ideals. They trade blood for money.\" "),
        ...
        public override string GetChat()
        {
            ...
            chat.Add(Language.GetTextValue("Pssst... Don't tell manifesto this, but i still play roblox... Please don't tell them, they threatened to turn me into an assault rifle last time..."));
            chat.Add(Language.GetTextValue("I messed with Autism Manifesto ONE TIME and now i'm a terraria npc smh"));
        ...
        public override void AddShops()
        {
...

            {
                ...
                npcShop.Add(BisexualDye.Type);
                npcShop.Add(DemiboyDye.Type);
                npcShop.Add(NonbinaryDye.Type);
                npcShop.Add(DemigirlDye.Type);
                npcShop.Add(AgenderDye.Type);
                npcShop.Add(DemigenderDye.Type);
                npcShop.Add(AsexualDye.Type);
                npcShop.Add(PansexualDye.Type);
                npcShop.Add(TransgenderDye.Type);
