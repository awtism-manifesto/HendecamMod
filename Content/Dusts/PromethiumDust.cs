...
public class PromethiumDust : ModDust
{
    ...
    {
        int desiredVanillaDustTexture = DustID.BlueFairy;
    ...
    {
        float lightR = 0.44f * dust.scale;
        float lightG = 0.85f * dust.scale;
        float lightB = 1.3f * dust.scale;
    ...
    {
        lightColor = Color.Lerp(lightColor, Color.LightBlue, 0.8f);
