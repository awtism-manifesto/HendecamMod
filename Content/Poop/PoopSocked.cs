...
{
    public class PoopSocked : ModBuff
    {
    ...
    public class PoopSockedDebuff : GlobalNPC
    {
        public override void ModifyHitByProjectile(NPC npc, Projectile projectile, ref NPC.HitModifiers modifiers)
        {
            ...
            if (npc.HasBuff<PoopSocked>())
            {
                // Apply a flat bonus to every hit
                modifiers.FlatBonusDamage += PoopSocked.TagDamage * projTagMultiplier;
            }
