...
public class PoopyShirt : ModItem
{
    ...
    public override void SetDefaults()
    {
        ...
        Item.value = Item.sellPrice(copper: 8); // How many coins the item is worth
    ...
    {
        return head.type == ModContent.ItemType<PoopyHelmet>() && legs.type == ModContent.ItemType<PoopyPants>();
    }
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient(ItemID.PoopBlock, 20);
