...
public class ShitPissAndCumWand : ModItem
{
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Shoots a poo shot that poisons enemies and makes them stinky, a piss stream that lowers enemy defense,");
        tooltips.Add(line);

        line = new TooltipLine(Mod, "Face", "And worst of all, homing sperm cells")
        {
            OverrideColor = new Color(255, 255, 255)
        };
        tooltips.Add(line);
        line = new TooltipLine(Mod, "Face", "Makes the user extremely stinky")
        {
            OverrideColor = new Color(255, 255, 255)
        };
        tooltips.Add(line);
