...
public class PoopyAutoPistol : ModItem
{
    public override void SetDefaults()
    {
        ...
        Item.UseSound = new SoundStyle($"{nameof(HendecamMod)}/Assets/Sounds/SMG")
        {
            Volume = 2.67f,
            PitchVariance = 0.2f,
            MaxInstances = 30,
    ...
    {
        type = ProjectileType<ChloroShit>();
    }
    ...
    public override void ModifyTooltips(List<TooltipLine> tooltips)
    {
        ...
        var line = new TooltipLine(Mod, "Face", "Converts all bullets into chlorophyte shitballs");
        tooltips.Add(line);
