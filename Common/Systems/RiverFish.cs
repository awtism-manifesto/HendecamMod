...
public class RiverFish : ModPlayer
    ...
    public override void CatchFish(FishingAttempt attempt, ref int itemDrop, ref int npcSpawn, ref AdvancedPopupRequest sonar, ref Vector2 sonarPosition)
        {
        bool inShimmer = Player.ZoneShimmer & Main.hardMode;
    ...
    public override void ModifyCaughtFish(Item fish)
        {
        if (Player.ZoneShimmer && Player.GetFishingConditions().BaitItemType != ItemID.Shimmerfly && Player.GetFishingConditions().BaitItemType != ItemID.EmpressButterfly && fish.rare != ItemRarityID.Quest)
            {
